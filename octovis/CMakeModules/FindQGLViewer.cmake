...
FIND_LIBRARY( QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG QGLViewerd2 ${QGLVIEWER_BASE_DIR})
...
IF( QGLViewer_INCLUDE_DIR )
  ...
  ELSEIF(QGLViewer_LIBRARY_DIR_WINDOWS)
    ...
    IF(QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG)
      MESSAGE(STATUS "QGLViewer2d found in ${QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG}")
      SET( QGLViewer_LIBRARIES optimized ${QGLViewer_LIBRARY_DIR_WINDOWS} debug ${QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG})
    ELSE(QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG)
      SET( QGLViewer_LIBRARIES ${QGLViewer_LIBRARY_DIR_WINDOWS})
    ENDIF(QGLViewer_LIBRARY_DIR_WINDOWS_DEBUG)
    SET( QGLViewer_FOUND 1 CACHE BOOL "Do we have QGLViewer?" FORCE )
